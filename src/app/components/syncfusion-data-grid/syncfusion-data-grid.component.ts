...
import { FormioCustomComponent } from '../../registerCustomComponents/elements.common';
...
export class SyncfusionDataGridComponent implements FormioCustomComponent<number>{
